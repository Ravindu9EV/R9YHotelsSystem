...
public class BookingServiceImplTest {
    ...
    void ShouldReturnErrorWhenSaveBookingWithEmptyFromDate(){
        BookingDTO bookingDTO=new BookingDTO(0L, BookingType.ROOM,"","sa",5,45.4,"asd");
    ...
    void ShouldReturnErrorWhenSaveBookingWithEmptyToDate(){
        BookingDTO bookingDTO=new BookingDTO(0L, BookingType.ROOM,"2025-04-14","",5,45.4,"asd");
        ResponseEntity<String> response=bookingService.save(bookingDTO);
        assertEquals("Missing field",response.getBody());
    ...
    void ShouldReturnErrorWhenSaveBookingWithNumberOfPeopleIsNull(){
        BookingDTO bookingDTO=new BookingDTO(0L, BookingType.ROOM,"","sa",null,45.4,"asd");
        ResponseEntity<String> response=bookingService.save(bookingDTO);
        assertEquals("Missing field",response.getBody());
    ...
    void ShouldReturnErrorWhenSaveBookingWithNumberOfPeopleIsLessThanZero(){
        BookingDTO bookingDTO=new BookingDTO(0L, BookingType.ROOM,"","sa",-1,45.4,"asd");
        ResponseEntity<String> response=bookingService.save(bookingDTO);
        assertEquals("Missing field",response.getBody());
    ...
    void ShouldReturnErrorWhenSaveBookingWithNumberOfPeopleIsEqualsZero(){
        BookingDTO bookingDTO=new BookingDTO(0L, BookingType.ROOM,"","sa",0,45.4,"asd");
        ResponseEntity<String> response=bookingService.save(bookingDTO);
        assertEquals("Missing field",response.getBody());
    ...
    void ShouldReturnErrorWhenSaveBookingWithPriceIsNull(){
        BookingDTO bookingDTO=new BookingDTO(0L, BookingType.ROOM,"","sa",4,null,"asd");
        ResponseEntity<String> response=bookingService.save(bookingDTO);
        assertEquals("Missing field",response.getBody());
    ...
    void ShouldReturnErrorWhenSaveBookingWithPriceIsLessThanZero(){
        BookingDTO bookingDTO=new BookingDTO(0L, BookingType.ROOM,"","sa",4,-1.0,"asd");
        ResponseEntity<String> response=bookingService.save(bookingDTO);
        assertEquals("Missing field",response.getBody());
    ...
    void ShouldReturnErrorWhenSaveBookingWithPriceIsZero(){
        BookingDTO bookingDTO=new BookingDTO(0L, BookingType.ROOM,"","sa",4,0.0,"asd");
        ResponseEntity<String> response=bookingService.save(bookingDTO);
        assertEquals("Missing field",response.getBody());
    ...
    void ShouldReturnErrorWhenSaveBookingWithNullDescription(){
        BookingDTO bookingDTO=new BookingDTO(0L, BookingType.ROOM,"","sa",4,5.6,null);
        ResponseEntity<String> response=bookingService.save(bookingDTO);
        assertEquals("Missing field",response.getBody());
    ...
    void ShouldReturnErrorWhenSaveBookingWithEmptyDescription(){
        BookingDTO bookingDTO=new BookingDTO(0L, BookingType.ROOM,"","sa",4,5.6,"");
        ResponseEntity<String> response=bookingService.save(bookingDTO);
        assertEquals("Missing field",response.getBody());
    ...
    void ShouldReturnSuccessMsgWhenSaveBookingWithValidObject(){
        BookingDTO bookingDTO=new BookingDTO(0L, BookingType.ROOM,"2025-04-14","2025-04-15",5,45.4,"asd");
        ResponseEntity<String> response=bookingService.save(bookingDTO);
